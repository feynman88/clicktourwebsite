              ...
              <div className="mt-10 max-w-xl text-base leading-7 text-gray-700 lg:max-w-none">
                ...
                <ul role="list" className="mt-8 space-y-8 text-gray-600">
                  <li className="flex gap-x-3">
                    ...
                    />
                    <span>
                      <strong className="font-semibold text-gray-900">Beach Escapes & Leisure</strong> Unwind on
                      pristine beaches and indulge in luxurious resorts. Our leisure packages offer the perfect blend of
                      relaxation and indulgence for those seeking a tranquil getaway.
                    </span>
                  </li>
                  <li className="flex gap-x-3">
                    <img
                  ...
                  <li className="flex gap-x-3">
                    ...
                    <span>
                      ...
                      Strengthen bonds and create lasting memories with our group and corporate travel options. We
                      handle all the details, allowing you to focus on what matters most – the shared experience.
                    </span>
                  </li>
                </ul>
